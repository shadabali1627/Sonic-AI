        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            ...
            >
                <div className="flex justify-center mb-6">
                    <div className="p-4 bg-cyan-500/10 rounded-2xl border border-cyan-500/25 shadow-[0_0_35px_-5px_rgba(6,182,212,0.3)] relative overflow-hidden group">
                ...
                <p className="text-sm text-gray-400 font-medium">
                    Welcome back to <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500 font-bold">Sonic AI</span>
                </p>
            </motion.div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid gap-5">
                        <div className="grid gap-2">
                            <Label htmlFor="email" className={cn("text-xs font-semibold uppercase tracking-wider text-gray-400 transition-colors", errors.email ? "text-red-400" : "group-focus-within/email:text-cyan-400")}>
                                Email or Username
                            </Label>
                            <div className="relative group/email">
                                ...
                                <Input
                                    ...
                                    disabled={isLoading}
                                    className={cn(
                                        "pl-10 h-11 bg-white/[0.02] border-white/10 rounded-xl focus:border-cyan-500/50 focus:ring-4 focus:ring-cyan-500/10 hover:bg-white/[0.04] hover:border-white/15 transition-all duration-300 placeholder:text-gray-600",
                        ...
                        <div className="grid gap-2">
                            <div className="flex items-center justify-between">
                                <Label htmlFor="password" className={cn("text-xs font-semibold uppercase tracking-wider text-gray-400 transition-colors", errors.password ? "text-red-400" : "group-focus-within/pass:text-cyan-400")}>
                                    Password
                                </Label>
                                <Link href="/forgot-password" className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors font-semibold hover:underline underline-offset-4">
                                    Forgot Password?
                                </Link>
                            </div>
                            <div className="relative group/pass">
                                ...
                                <Input
                                    ...
                                    disabled={isLoading}
                                    className={cn(
                                        "pl-10 pr-10 h-11 bg-white/[0.02] border-white/10 rounded-xl focus:border-cyan-500/50 focus:ring-4 focus:ring-cyan-500/10 hover:bg-white/[0.04] hover:border-white/15 transition-all duration-300 placeholder:text-gray-600",
                        ...
                        <div className="flex items-center space-x-2 my-1">
                            <input
                                type="checkbox"
                                id="remember"
                                className="w-4 h-4 rounded border-gray-600 bg-gray-900/50 text-cyan-500 focus:ring-cyan-500/50 focus:ring-offset-0 transition-all cursor-pointer"
                                {...register("remember")}
                            />
                        ...
                        <div className="relative group">
                            <div className="absolute -inset-1 bg-linear-to-r from-cyan-500 to-blue-600 rounded-xl blur-lg opacity-40 group-hover:opacity-80 transition duration-500 animate-pulse"></div>
